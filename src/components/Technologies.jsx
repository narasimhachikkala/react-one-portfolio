...
const Technologies = () => {
  const techs = [
    ...
    { id: 6, src: java, title: "Java", style: "shadow-sky-300" },
    { id: 7, src: python, title: "Python", style: "shadow-yellow-400" },
    { id: 8, src: postgreSQL, title: "PostgreSQL", style: "shadow-blue-300" },
    { id: 9, src: mysql, title: "MySQL", style: "shadow-orange-400" },
    { id: 10, src: mongoDB, title: "MongoDB", style: "shadow-green-500" },
    { id: 11, src: aws, title: "AWS", style: "shadow-blue-100" },
  ...
  return (
    <div
      name="technologies"
      className="bg-gradient-to-b from-gray-800 to-black w-full text-white pt-20" // Added padding-top
    >
